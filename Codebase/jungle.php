...
<head>
    ...
    <title>Jungle Set Page</title>
    <link href="style_home.css" rel="stylesheet"/>
</head>
<body>
<section class="flexboxh1">
    <div class="boxed">
        <form action="jungle.php" method="post">
        </form>
</section>
...
<div class="hero-image_jungle">
    <div class="subheadline">
        <h2 class="text-shadow">
            Step into the Jungle <br> with the first expansion Set from 1999
        </h2>
    </div>
</div>
